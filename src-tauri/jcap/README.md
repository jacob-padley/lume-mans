...
fn main() {
    ...
    if !jcap::has_permission() {
        println!("❌ Permission not granted. Requesting permission...");
        if !jcap::request_permission() {
    ...
    let options = Options {
        ...
        output_type: jcap::frame::FrameType::BGRAFrame,
        output_resolution: jcap::capturer::Resolution::_720p,
        crop_area: Some(Area {
